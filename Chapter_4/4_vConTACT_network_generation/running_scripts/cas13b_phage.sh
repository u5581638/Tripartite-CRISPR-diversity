...
# script to perform vConTACT2 network generation using phage-encoded Type VI-B genomes.
...
input_dir=/g/data/va71/vConTACT2/MAVERICLab-vcontact2-c0413a6c92e8/bin/cas13b/phage/
input_protein=cas13b.fasta_all_hits.csv_genomes.fasta_crisprs.lst_full_real_arr_positions.csv_all_hits_blast_filtered_hitmap.csv_standardised.csv_faidx_bp_window.fasta_nr.fa_aa_raw.fasta
output_protein=cas13b_phage_g2g.csv
output_dir=cas13b_phage_network
