...
# script to perform vConTACT2 network generation using host-encoded Type VI-D genomes.

input_dir=/g/data/va71/vConTACT2/MAVERICLab-vcontact2-c0413a6c92e8/bin/cas13d/host/
input_protein=cas13d.fasta_all_hits.csv_genomes.fasta_aa_raw.fasta
output_protein=cas13d_host_g2g.csv
output_dir=cas13d_host_network
