...
# OUTPUT: table containing only the top 30 largest partitions
#		 i.e. cas12a_host_only_partition_top30.csv
# SHELL: python3 top_30_network_only.py <input_file.csv> <output_file.csv>
