...
# 		 i.e. cas13b.fasta (located in "queries/" folder)
...
#		 i.e. "cas13b/genomes/" containing "spliced_debug_corrected_cleaned_rerun_20kb_local_windows_combined.fasta" and associated files for running BLAST
...
#		  i.e. cas13b.fasta_all_hits.csv_genomes.fasta_crisprs.lst_full_real_arr_positions.csv_all_hits_blast_filtered_hitmap.csv_standardised.csv
#		  2. FASTA file containing a list of "host" encoding contigs
#		  i.e. cas13b.fasta_all_hits.csv_genomes.fasta_crisprs.lst_full_real_arr_positions.csv
...
#		  i.e. cas13b.fasta_all_hits.csv_genomes.fasta_crisprs.lst_full_real_arr_positions.csv_all_hits_blast_filtered_hitmap.csv_standardised.csv_non_redundant.csv_filtered.csv_2_or_more_hits.csv_distances_annotated.csv
#		  5. Preliminary PAM concensous predictions for each subtype (not used)
#		  i.e. cas13b.fasta_all_hits.csv_genomes.fasta_crisprs.lst_full_real_arr_positions.csv_all_hits_blast_filtered_hitmap.csv_standardised.csv_non_redundant.csv_filtered.csv_pam_summary.csv
