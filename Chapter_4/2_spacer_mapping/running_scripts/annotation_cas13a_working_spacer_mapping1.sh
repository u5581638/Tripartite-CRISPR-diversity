...
#		  i.e. cas13a.fasta_all_hits.csv_genomes.fasta_crisprs.lst_full_real_arr_positions.csv
#		  3. FASTA file containing spacer mapped target contigs (in FASTA format)
#		  i.e. cas13a.fasta_all_hits.csv_genomes.fasta_crisprs.lst_full_real_arr_positions.csv_all_hits_blast_filtered_hitmap.csv_standardised.csv_non_redundant.csv_filtered.csv_deduplicated.csv_filtered_hits_extracted_faidx_bp_window.fasta
#		  4. Preliminary table of PPS-spacer distances (not used)
#		  i.e. cas13a.fasta_all_hits.csv_genomes.fasta_crisprs.lst_full_real_arr_positions.csv_all_hits_blast_filtered_hitmap.csv_standardised.csv_non_redundant.csv_filtered.csv_2_or_more_hits.csv_distances_annotated.csv
#		  5. Preliminary PAM concensous predictions for each subtype (not used)
#		  i.e. cas13a.fasta_all_hits.csv_genomes.fasta_crisprs.lst_full_real_arr_positions.csv_all_hits_blast_filtered_hitmap.csv_standardised.csv_non_redundant.csv_filtered.csv_pam_summary.csv
