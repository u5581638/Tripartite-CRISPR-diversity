...
# program to parse the output from HMM programs
...
# INPUT: Output of pfam queried file from HHblits.
#  i.e. sequence_999_pfam_descriptions.txt
# OUTPUT: Conversion of output to csv format.
# i.e. sequence_997_pfam_descriptions.txthits.csv
# SHELL: See running_scripts/pfam_annotations_running_script.sh

pdb70_parse_pfam(sys.argv[1])	