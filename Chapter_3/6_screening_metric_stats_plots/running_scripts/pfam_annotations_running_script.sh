...
# INPUT: representative ORF sequence between 0-10kb from the CRISPR-array
# OUTPUT: hhblits and Hmmscan annotations from PFAM and DEFLOC respectively, for each representative ORF.
