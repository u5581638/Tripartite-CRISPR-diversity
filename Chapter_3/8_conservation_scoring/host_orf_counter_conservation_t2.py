...
# i.e. cas13b.fasta_all_hits.csv_genomes.fasta_annotations_all.csv Note: some subtypes have different column lengths which nessessitates using host_orf_counter_conservation_t2.py 
...
# SHELL: host_orf_counter_conservation_t2.py cas13b.fasta_all_hits.csv_genomes.fasta_annotations_all.csv

with open(sys.argv[1],"r") as csvfile:
	proteins = list(csv.reader(csvfile))
