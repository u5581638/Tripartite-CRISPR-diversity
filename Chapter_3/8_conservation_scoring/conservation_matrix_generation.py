...
# INPUT: list of conservation tables from each CRISPR-Cas subtype
# i.e. Cas13b.fasta_all_hits.csv_genomes.fasta_annotations_all.csv_conservation.csv
# OUTPUT: matrix showing conservation scores for the same conserved protein annotations from each subtype.
# i.e. conservation_matrix_pfam_500_all.csv
# SHELL: python3 conservation_matrix_generation.py cas12a.fasta_all_hits.csv_genomes.fasta_annotations.csv_conservation.csv cas12b.fasta_all_hits.csv_genomes.fasta_annotations.csv_conservation.csv .. etc <output_matrix_name>
