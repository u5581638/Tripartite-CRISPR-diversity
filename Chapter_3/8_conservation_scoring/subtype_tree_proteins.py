...
# INPUT: 1. CRISPR_subtype annotation_table
#		 2. Predicted proteins from annotated genomes
#		 3. query/annotation name to extract from annotation table
# SHELL: see query_batch_retrieval2.sh in running_scripts/
...
# OUTPUT: set of protein sequences for alignment in FASTA format.
