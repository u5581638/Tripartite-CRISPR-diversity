...
# INPUT: FASTA file generated by mmseqs2, containing protein sequences grouped by cluster.
# i.e. deduplicated_flattened_all_sequences.fasta
# OUTPUT: FASTA file containing protein sequence clusters grouped and sorted in descending order.
# i.e. sorted_descending_deduplicated_flattened_all_sequences.fasta
# SHELL: python3 cluster_sorter.py deduplicated_flattened_all_sequences.fasta
