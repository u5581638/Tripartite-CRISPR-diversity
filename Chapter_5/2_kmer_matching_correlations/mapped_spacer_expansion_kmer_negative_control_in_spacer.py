...
#		  i.e cas12a_neg_cntl_parallel_gadi_kmer14_29-3-2024.csv
#		  2. table containing kmer matches to associated direct repeats on each contig
#		  i.e. cas12a_neg_cntl_parallel_gadi_kmer14_29-3-2024.csv_dr.csv
# SHELL: see cas12a_kmer_neg_cntl_detection_14kmer.sh
